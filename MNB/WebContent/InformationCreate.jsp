...
<body>
	<form name ="addNews" action="InformationDatabaseProcessing" method="post">
	<div Align = "right">
	...
	<br>
		...
		<%
		out.println("<tr>");
		out.println("<caption>お知らせ追加</caption>");
		out.println("</tr>");
		out.println("<tr>");
		...
		<p>
			<a href="javascript:document.addNews.submit()" class="square_btn_decide">確定</a>
